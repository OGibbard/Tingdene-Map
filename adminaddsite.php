...
try{
    ...
    #Prepare statement for inserting new site to database
    ...
    #Replace placeholders with the inputs
    ...
    #Create the new websitelink from the site name
